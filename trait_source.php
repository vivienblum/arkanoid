   ...
   <body>
      ...
      <div class="division_centrale">
         ...
         <?php
          $choix=$_POST['accords'];
          if ($choix=='TRUE'){
          	echo "<p>Vous pouvez télécharger le code source <a href='dl/dl_source.txt'>ici</a>.</p>";}
          else{
            echo "<p>Vous devez accetper les conditions générales d'utilisation <a href='code_source.php'>ici</a>.</p>";}
         ?>
      </div>
